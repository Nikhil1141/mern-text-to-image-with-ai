...
const Description = () => {
  return (
    // <motion.div className='flex flex-col items-center justify-center my-24 p-6 md:px-28' initial={{ opacity: 0.2, y: 100 }} transition={{ duration: 1 }} whileInView={{opacity: 1, y: 0.1}} viewport={{once: true}}>
    //     <h1 className='text-3xl sm:text-4xl font-semibold mb-2'>Create AI Images</h1>
    //     <p className='text-gray-500 mb-8'>Turn your imagination into visuals</p>

    //     <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
    //         <img src={assets.sample_img_1} alt="sample_img1" className='w-80 xl:w-96 rounded-lg' />
    ...
    <motion.div className='flex flex-col items-center justify-center my-24 p-6 md:px-28' initial={{ opacity: 0.2, y: 100 }} transition={{ duration: 1 }} whileInView={{ opacity: 1, y: 0.1 }} viewport={{ once: true }}>
      ...
      <div className='flex flex-col-reverse xl:flex-row gap-8 xl:gap-14 items-center'>
        <img src={assets.sample_img_1} alt="sample_img1" className='w-80 xl:w-96 rounded-lg' />
        <div className='text-center lg:text-left'>
          <h2 className='text-2xl sm:text-3xl font-medium max-w-lg mb-4'>
