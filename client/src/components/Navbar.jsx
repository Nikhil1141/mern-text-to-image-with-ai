...
//                                 className='cursor-pointer text-sm sm:text-base text-gray-600 hover:underline'
//                             >
//                                 Dashboard
//                             </p>
        ...
        <div className='absolute top-[64px] right-0 w-full bg-white py-6 px-6 flex flex-col gap-4 sm:hidden shadow-md z-40'>
          {user ? (
            ...
            <>
              ...
              <button onClick={() => { setShowLogin(true); closeMenu(); }} className='bg-zinc-800 text-white px-5 py-2 rounded-full'>Login</button>
            </>
          )}
        </div>
      )}
